...
<body>
 ...
 <div class="main-container">
        ...
        <div class="container">
            <form action="">
                <h2>Inscription-Réseaux sociaux de l'atelier</h2>
                <div class="input-container" style="display: flex; margin-left:16%; margin-bottom:4%;">
                    <i class="mdi mdi-instagram" style="font-size: 24px; margin-top:2%;"></i>
                    <input type="text" class="custom-input-2" placeholder="Lien Instagram">
                </div>

                <div class="input-container" style="display: flex; margin-left:16%; margin-bottom:4%;">
                    <i class="mdi mdi-facebook" style="font-size: 24px; margin-top:2%;"></i>
                    <input type="text" class="custom-input-2" placeholder="Lien Facebook">
                </div>
                
                <div class="input-container" style="display: flex; margin-left:16%; margin-bottom:4%;">
                    <i class="mdi mdi-link" style="font-size: 24px; margin-top:2%;"></i>
                    <input type="text" class="custom-input-2" placeholder="Lien Tiktok">
                </div>
