            ...
            <div>
                ...
                <div style="margin-top: 12%; margin-left: 30%" >
                    <div class="input-container" >
                        ...
                        <input type="text" class="custom-input-3" placeholder="Nom Atelier">
                    </div>
                </div>
                ...
                <div style="margin-top: 2%; margin-left: 30%" >
                    <div class="input-container" >
                        ...
                        <input type="text" class="custom-input-3" placeholder="Instagram">
                    </div>
                </div>
                <div style="margin-top: 2%; margin-left: 30%" >
                    <div class="input-container" >
                        <i class="mdi mdi-home-account" style="font-size: 24px;"></i>
                        <input type="text" class="custom-input-3" placeholder="Facebook">
                    </div>
                </div>
                <div style="margin-top: 2%; margin-left: 30%" >
                    <div class="input-container" >
                        <i class="mdi mdi-home-account" style="font-size: 24px;"></i>
                        <input type="text" class="custom-input-3" placeholder="Tiktok">
                    </div>
                </div>
