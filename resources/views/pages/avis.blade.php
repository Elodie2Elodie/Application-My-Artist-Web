...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="assets/css/page_note_et_avis.css">
    <!-- End layout styles -->
      ...
      <div class="container-fluid page-body-wrapper" >
          ...
          <ul class="nav" style="margin-top: 20px;">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ route('avis') }}">
                ...
                <span class="menu-title">Notes et Avis</span>
        ...
        <div class="container-21" style="margin-left: 14%; margin-top: 6%">
            ...
            <div class="group-note-globale">
              ...
              <div class="icround-star">
                <img class="vector-3" src="../assets/vectors/vector_624_x2.svg" />
              </div>
              <div class="icround-star-1">
                <img class="vector-4" src="../assets/vectors/vector_206_x2.svg" />
              </div>
              <div class="icround-star-2">
                <img class="vector-5" src="../assets/vectors/vector_617_x2.svg" />
              </div>
            </div>
              ...
              <div class="group-1000004757">
                <div class="container-10">
                    ...
                    <div class="group-1000004756">
                        <div class="icround-star-13">
                        <img class="vector-17" src="../assets/vectors/vector_578_x2.svg" />
                        </div>
                        <div class="icround-star-14">
                        <img class="vector-18" src="../assets/vectors/vector_273_x2.svg" />
                        </div>
                        <div class="icround-star-15">
                        <img class="vector-19" src="../assets/vectors/vector_150_x2.svg" />
                        </div>
                    </div>
                </div>
